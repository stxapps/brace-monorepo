...
// device-extraction's `403` ladder handles. brace-extractor states the same
// thing with its own string (`brace-extractor/1.0 (+…/extractor)`) —
...
export const USER_AGENT = 'Brace/1 (+https://brace.to)';
