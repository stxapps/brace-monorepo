...
// the web app's library in a new tab. It reads "Open Bracemark" (navigation), not "view
// this link": the extension's session doesn't cross origins (docs/browser-extension.md), so
// a user who never signed in to bracemark-web lands on its sign-in page first.
