...
// Signed-out popup: the SAME presentational sign-in form bracemark-web uses (shared from
...
// sign-in (it can't inherit bracemark-web's non-extractable key across origins), but it
// never creates accounts itself.
export function SignIn() {
  return (
    <div className="flex w-85 flex-col gap-3 p-4">
      <h1 className="text-base font-semibold">Sign in to Bracemark</h1>
      <SignInForm />
      <p className="text-sm">
        New to Bracemark?{' '}
        <button
