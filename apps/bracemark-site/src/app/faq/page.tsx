...
export default function Page() {
  ...
  return (
    <div className={cn('mx-auto max-w-6xl px-4 pt-14 pb-4 md:px-6 md:pt-20 lg:px-8')}>
      <header className={cn('max-w-3xl')}>
        ...
        <p className={cn('text-muted-foreground mt-5 max-w-2xl text-lg leading-8')}>
          An app built so we can’t read your library also can’t recover it for you. That trade runs
          through most of what follows, so it is stated plainly rather than buried.
        </p>
      </header>
          ...
          >
            <div>
              ...
              <p className={cn('text-muted-foreground mt-2 max-w-md text-[0.9375rem] leading-7')}>
                Write to us and a person answers. Or start with {freeLinks} free links and find the
