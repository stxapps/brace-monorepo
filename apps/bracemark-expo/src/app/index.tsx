...
// analogue of bracemark-web's `src/app/page.tsx`. Thin route: the presentational UI
...
//
// AuthedHomeRedirect (mirroring bracemark-web's page.tsx) bounces already-authenticated
