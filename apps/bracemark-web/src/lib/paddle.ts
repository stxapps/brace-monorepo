...
// App-level Paddle Billing wrapper — bracemark-web is the ONLY checkout surface
...
// Payment completion reaches bracemark-api via Paddle's webhook, NOT this client;
