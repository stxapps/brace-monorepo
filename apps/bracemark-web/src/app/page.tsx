...
// TODO: PLACEHOLDERS, same story as the browser-extension listings in
// ../lib/extension-stores.ts — the values these replaced addressed the legacy Brace.to
// apps (`com.bracedotto`, App Store id 1531456778), and Bracemark ships brand-new
// listings because the bundle identifier changes (docs/brand.md). Fill in at store
// submission; until then these link nowhere rather than to the wrong product.
const PLAY_STORE_URL = 'https://play.google.com/store/apps/details?id=com.bracemark.app';
const APP_STORE_URL = 'https://apps.apple.com/us/app/idTODO_APP_STORE_ID';
